 ...
 */
final class Version20230124081516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande (id INT AUTO_INCREMENT NOT NULL, user_fait_demande_id INT DEFAULT NULL, plante_contient_demande_id INT DEFAULT NULL, user_recoi_demande_id INT DEFAULT NULL, date_de_creation DATETIME DEFAULT NULL, etat VARCHAR(255) DEFAULT NULL, INDEX IDX_2694D7A59216E597 (user_fait_demande_id), INDEX IDX_2694D7A556ED677C (plante_contient_demande_id), INDEX IDX_2694D7A55C308816 (user_recoi_demande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, lat DOUBLE PRECISION DEFAULT NULL, lng DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, delivered_at DATETIME DEFAULT NULL, INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE demande ADD CONSTRAINT FK_2694D7A59216E597 FOREIGN KEY (user_fait_demande_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE demande ADD CONSTRAINT FK_2694D7A556ED677C FOREIGN KEY (plante_contient_demande_id) REFERENCES plante (id)');
        $this->addSql('ALTER TABLE demande ADD CONSTRAINT FK_2694D7A55C308816 FOREIGN KEY (user_recoi_demande_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande DROP FOREIGN KEY FK_2694D7A59216E597');
        $this->addSql('ALTER TABLE demande DROP FOREIGN KEY FK_2694D7A556ED677C');
        $this->addSql('ALTER TABLE demande DROP FOREIGN KEY FK_2694D7A55C308816');
