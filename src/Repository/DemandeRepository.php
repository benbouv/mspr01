...
class DemandeRepository extends ServiceEntityRepository
{
    ...
    public function findByUserFaitId($idvalue): array
    {
         return $this->createQueryBuilder('p')
            ->andWhere('p.UserFaitDemande = :val')
    ...
    public function findByUserRecoiId($idvalue): array
    {
         return $this->createQueryBuilder('p')
            ->andWhere('p.UserRecoiDemande = :val')
            ->setParameter('val', $idvalue)
            ->getQuery()
            ->getResult()
         ;
